...
(cl:defmethod cl:initialize-instance :after ((m <Thruster>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Thruster)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name autonomous_rov-msg:<Thruster> is deprecated: use autonomous_rov-msg:Thruster instead.")))
...
(cl:defmethod commands-val ((m <Thruster>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader autonomous_rov-msg:commands-val is deprecated.  Use autonomous_rov-msg:commands instead.")
  (commands m))
