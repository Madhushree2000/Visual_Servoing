...
"""autogenerated by genpy from autonomous_rov/Health.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6f2B().pack(_x.cpu_used, _x.mem_used, _x.v_batt, _x.i_batt, _x.t_internal, _x.p_internal, _x.sw_1, _x.sw_2))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.cpu_used, _x.mem_used, _x.v_batt, _x.i_batt, _x.t_internal, _x.p_internal, _x.sw_1, _x.sw_2,) = _get_struct_6f2B().unpack(str[start:end])
