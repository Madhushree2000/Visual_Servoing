...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<OverrideRCIn>)))
  ...
  (cl:format cl:nil "# Override RC Input~%# Currently MAVLink defines override for 18 channels~%~%# https://mavlink.io/en/messages/common.html#RC_CHANNELS_OVERRIDE~%~%uint16 CHAN_RELEASE=0~%uint16 CHAN_NOCHANGE=65535~%~%uint16[8] channels~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'OverrideRCIn)))
  "Returns full string definition for message of type 'OverrideRCIn"
  (cl:format cl:nil "# Override RC Input~%# Currently MAVLink defines override for 18 channels~%~%# https://mavlink.io/en/messages/common.html#RC_CHANNELS_OVERRIDE~%~%uint16 CHAN_RELEASE=0~%uint16 CHAN_NOCHANGE=65535~%~%uint16[8] channels~%~%~%"))
