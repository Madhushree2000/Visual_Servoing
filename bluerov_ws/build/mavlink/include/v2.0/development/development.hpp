...
enum class COMPONENT_CAP_FLAGS1 : uint64_t
{
    ...
    COMPONENT_INFORMATION=4, /* Component supports the component information protocol. | */
    GIMBAL_V2=8, /* Component supports the gimbal v2 protocol. | */
    MAVLINK_FTP=16, /* Component supports the MAVLink FTP protocol. | */
    EVENTS_INTERFACE=32, /* Component supports the events interface protocol. | */
    CAMERA=64, /* Component supports the camera v1 protocol. | */
    CAMERA_V2=128, /* Component supports the camera v2 protocol. | */
};

//! COMPONENT_CAP_FLAGS1 ENUM_END
constexpr auto COMPONENT_CAP_FLAGS1_ENUM_END = 129;
